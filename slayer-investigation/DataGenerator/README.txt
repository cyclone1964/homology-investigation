...
A python script that makes the point clouds. It supports lots of shapes by default but the number can be reduced with command line arguments. Creates files:
...
A program that brakds the barcode files into three "slayer intput" files of the name
